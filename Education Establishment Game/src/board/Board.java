...
public class Board {
	...
	private void initialiseSquares(){
		...
		Squares[1] = new Subject("Philosophy", "brown", 60, new int[] {2,10,30,90,160,250});
		Squares[2] = new SpecialSquare(Type.ComunityChest, CommunityChest);
		Squares[3] = new Subject("Politics", "brown", 60, new int[] {4,20,60,180,320,450});
		Squares[4] = new SpecialSquare(Type.IncomeTax, IncomeTax);
		Squares[5] = new Bar("Speakeasy",200);
		Squares[6] = new Subject("History", "lightblue", 100, new int[] {6,30,90,270,400,550});
		Squares[7] = new SpecialSquare(Type.ChanceCard, ChanceCard);
		Squares[8] = new Subject("Anthropology", "lightblue", 100, new int[] {6,30,90,270,400,550});
		Squares[9] = new Subject("Theology", "lightblue", 120, new int[] {8,40,100,300,450});
		...
		Squares[18] = new Subject("Microbiology", "orange", 100, new int[] {14,70,200,550,750,950});
		Squares[19] = new Subject("Marine Biology", "orange", 100, new int[] {16,80,220,600,800,1000});
		
		//Row 3
		Squares[20] = new SpecialSquare(Type.FreeParking, FreeParking);
		Squares[21] = new Subject("Medical Chemistry", "red", 100, new int[] {18,90,250,700,875,1050});
		Squares[22] = new SpecialSquare(Type.ChanceCard, ChanceCard);
		Squares[23] = new Subject("Chemistry", "red", 100, new int[] {18,90,250,700,875,1050});
		Squares[24] = new Subject("Chemical Engineering", "red", 100, new int[] {20,100,300,750,925,1100});
		...
		Squares[31] = new Subject("Dentistry", "green", 120, new int[] {26,130,390,900,1100,1275});
		Squares[32] = new Subject("Nursing", "green", 120, new int[] {26,130,390,900,1100,1275});
		Squares[33] = new SpecialSquare(Type.ComunityChest, CommunityChest);
		Squares[34] = new Subject("Human Genetics", "green", 120, new int[] {28,150,450,1000,1200,1400});
		Squares[35] = new Bar("Cuckoo",200);
		Squares[36] = new SpecialSquare(Type.ChanceCard, ChanceCard);
		Squares[37] = new Subject("Electrical and Electronic Engineering", "darkblue", 100, new int[] {35,175,500,1100,1300,1500});
		Squares[38] = new SpecialSquare(Type.SuperTax, SuperTax);
		Squares[39] = new Subject("Computer Science", "darkblue", 120, new int[] {50,200,600,1400,1700,2000});
